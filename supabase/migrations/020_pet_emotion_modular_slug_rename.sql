-- Renombra slugs legacy al mapa de la lámina GUARDDH v2; vuelve a aplicar `atlas_slot` coherentes.

UPDATE public.pet_emotion_definitions
SET slug = 'espera_sincronizacion'
WHERE slug = 'ayuda_exitosa_simple';

UPDATE public.pet_emotion_definitions
SET slug = 'vinculo_tiempo'
WHERE slug = 'ruta_alternativa';
